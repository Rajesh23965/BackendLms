...
exports.minifyTemplate = void 0;
const minifyTemplate = async (html, templateMinifierOptions) => {
    try {
        const htmlnano = await Promise.resolve().then(() => __importStar(require("htmlnano")));
